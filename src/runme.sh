...
WORKSPACE='/home/cdd/DCASE2019/task_1/workspace_evaluation'
...
# Subtask a:
#python utils/features.py calculate_feature_for_all_audio_files --dataset_dir=$DATASET_DIR --subtask='a' --data_type='evaluation' --workspace=$WORKSPACE
#python utils/features_left.py calculate_feature_for_all_audio_files --dataset_dir=$DATASET_DIR --subtask='a' --data_type='evaluation' --workspace=$WORKSPACE
#python utils/features_right.py calculate_feature_for_all_audio_files --dataset_dir=$DATASET_DIR --subtask='a' --data_type='evaluation' --workspace=$WORKSPACE
#python utils/features_side.py calculate_feature_for_all_audio_files --dataset_dir=$DATASET_DIR --subtask='a' --data_type='evaluation' --workspace=$WORKSPACE
...
#python utils/features.py calculate_scalar --subtask='a' --data_type='evaluation' --workspace=$WORKSPACE
#python utils/features_left.py calculate_scalar --subtask='a' --data_type='evaluation' --workspace=$WORKSPACE
#python utils/features_right.py calculate_scalar --subtask='a' --data_type='evaluation' --workspace=$WORKSPACE
#python utils/features_side.py calculate_scalar --subtask='a' --data_type='evaluation' --workspace=$WORKSPACE
...
CUDA_VISIBLE_DEVICES=$GPU_ID python pytorch/main_evaluation.py inference_validation --dataset_dir=$DATASET_DIR --workspace=$WORKSPACE --subtask='a' --data_type='evaluation' --holdout_fold=1 --model_type=$MODEL_TYPE --iteration=17800 --batch_size=$BATCH_SIZE --cuda
